...
class WasteRoomServiceImplTest {
    ...
    void saveWasteRoom_ValidRequest_ReturnsDTO() {
        WasteRoomRequest request = new WasteRoomRequest(10, 5, 12, 2, List.of(), List.of(), 1L);
    ...
    void saveWasteRoom_ValidRequest_NullLists() {
        WasteRoomRequest request = new WasteRoomRequest(10, 5, 12, 2, null, null, 1L);
    ...
    void saveWasteRoom_InvalidRequest_WrongPropertyId() {
        WasteRoomRequest request = new WasteRoomRequest(10, 5, 12, 2, null, null, 10203L);
    ...
    void updateWasteRoom_ValidRequest_ReturnUpdatedDTO() {
        Long wasteRoomId = 1L;
        WasteRoomRequest request = new WasteRoomRequest(12.5, 8.0, 1.0, 2.0, List.of(), List.of(),1L);
        ...
        existingRoom.setX(0);
        existingRoom.setY(0);
        existingRoom.setContainers(List.of());
        existingRoom.setDoors(List.of());
    ...
    void updateWasteRoom_ValidRequest_ReturnChangedContainers() {
        ...
        WasteRoomRequest request = new WasteRoomRequest(12.5, 8.0, 1.0, 2.0, List.of(), newContainers, 1L);
