...
public final class ExceptionResponseUtil {
    ...
    public static org.springframework.http.ResponseEntity<com.avfallskompassen.dto.PropertyResponse> propertyResponse(
            HttpStatus status, boolean success, String message) {
        com.avfallskompassen.dto.PropertyResponse resp = new com.avfallskompassen.dto.PropertyResponse(success, message);
        return org.springframework.http.ResponseEntity.status(status).body(resp);
    }

    public static org.springframework.http.ResponseEntity<com.avfallskompassen.dto.PropertyResponse> propertyBadRequest(String message) {
        return propertyResponse(HttpStatus.BAD_REQUEST, false, message);
    }

    public static org.springframework.http.ResponseEntity<com.avfallskompassen.dto.PropertyResponse> propertyUnauthorized(String message) {
        return propertyResponse(HttpStatus.UNAUTHORIZED, false, message);
    }

    public static org.springframework.http.ResponseEntity<com.avfallskompassen.dto.PropertyResponse> propertyForbidden(String message) {
    ...
    public static org.springframework.http.ResponseEntity<com.avfallskompassen.dto.PropertyResponse> propertyResponse(
            org.springframework.http.HttpStatusCode status, com.avfallskompassen.dto.PropertyResponse body) {
