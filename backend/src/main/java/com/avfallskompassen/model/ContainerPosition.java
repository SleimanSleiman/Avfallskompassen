...
@Table(
        ...
        indexes = {
            @Index(name = "idx_container_position_waste_room_id", columnList = "waste_room_id"),
            @Index(name = "idx_container_position_container_plan_id", columnList = "container_plan_id")
        }
)
